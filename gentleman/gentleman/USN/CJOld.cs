...
namespace Tagtoo1
{
    ...
    //    private Dictionary<UInt64, FileNameAndFrn> Directories = null;
    ...
    //            0,                          // In Buffer Size  
    //            out ujd,                    // Out Buffer  
    //            Marshal.SizeOf(ujd),        // Size Of Out Buffer  
    //            out bytesReturned,          // Bytes Returned  
    //            IntPtr.Zero);               // lpOverlapped  

    //        return ujd;
    //    }
    //    public Dictionary<UInt64, FileNameAndFrn> EnumVolume(Int64 lowUsn, Int64 highUsn, string[] FileExtensionFilter)
    //    {
    ...
    //        Dictionary<UInt64, FileNameAndFrn> files = new Dictionary<ulong, FileNameAndFrn>();
    ...
    //            Marshal.SizeOf(med),                // Command Block Size
    //            pData,                              // Output buffer
    ...
    //        var re = mft.EnumVolume(0, Int64.MaxValue, null);
